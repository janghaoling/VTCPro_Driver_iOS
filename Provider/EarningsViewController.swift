...
extension EarningsViewController {
    ...
    func setValueForTarget(){
        ...
        self.headerView?.labelMoney.text = Formatter.shared.appPriceFormat(string: "\(Float.removeNil(total))")
...
extension EarningsViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelTotal.text = Formatter.shared.appPriceFormat(string: "\(self.headerArray?[indexPath.row].payment?.provider_pay ?? 0 )")
