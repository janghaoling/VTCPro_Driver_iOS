    ...
    private var balance : Float = 0 {
        didSet {
            DispatchQueue.main.async {
                self.labelWalletAmount.text = Formatter.shared.appPriceFormat(string: "\(self.balance)")
...
extension WalletViewController {
    ...
    private func initialLoads() {
        ...
        self.labelWalletAmount.text = Formatter.shared.appPriceFormat(string: "2222")
