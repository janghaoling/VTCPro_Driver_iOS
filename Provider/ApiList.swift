...
enum Base : String{
    ...
    case assignedCancel = "/api/provider/requests/upcoming/cancel"
    
    case assignedAccept = "/api/provider/requests/upcoming/accept"
    ...
    case deleteCard = "/api/provider/card/delete"
    ...
    case getAds = "/api/provider/get_advertisements"
    ...
    case requestSMS = "/api/provider/requestSMS"
    
    case verifySMS = "/api/provider/verifySMS"
