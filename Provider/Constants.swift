...
struct Constants {
    ...
    let walkthroughWelcome = "Introducing VTCPro Driver to take rides from the VTCPro app users."
    ...
    let tapWhenStopped = "tap when stopped"
    let dropped  = "DROPPED"
    ...
    let Every = "Every"
    // current ride
    let Driver_informations = "Driver informations";
    let Passenger_informations = "Passenger informations";
    let Booking_informations = "Booking informations";
    let Booking_ID = "Booking ID";
    let Booking_datetime = "Booking date & time";
    let Pickup_datetime = "Pickup date & time";
    let Ride_cost = "Ride cost";
    let empty = "EMPTY"
...
struct DateFormat {
    ...
    let yyyymmddHHMMss = "dd-MM-yyyy HH:mm:ss"
    let hhMMTTA = "HH:mm:ss"//"hh:MM TT a"
    let yyyymmdd = "dd-MM-yyyy"
    let ddmmmmyyyy = "dd MM yyyy"
    let yyyyMM = "MM-yyyy"
    let MMyyyy = "MM.yyyy"
